...
import com.contentFailedToLoad.mymemory.models.MemoryCard
...
class MemoryBoardAdapter(
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            // if card is face up show image
            if (memoryCard.isFaceUp){
                if (memoryCard.imageUrl != null){
                    // if the imeageUrl is not null then get the custom image and show
                ...
                // if it is not flipped over then show background
